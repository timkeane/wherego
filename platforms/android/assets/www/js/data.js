...
var PROPER_FIELDER_POSITON = {
	0: {
		1: {
			...
			3: {position: BASE[1], fielding: true},
		...
		2: {
			...
			2: {position: HIT_LOCATION[2], fielding: true},
			3: {position: BASE[1], fielding: true},
		...
		3: {
			throwsToMake: [1],
			out: true,
			1: {position: BASE[1], fielding: true},
			2: {position: {left: 685, top: 575}},
			3: {fielding: true},
			4: {position: {left: 695, top: 340}},
			5: {},
		...
		8: {
			...
			2: {position: BASE.H},
			3: {position: BASE[1]},
			4: {position: BASE[2], fielding: true},
			5: {position: BASE[3]},
		...
		LC: {
			...
			8: {position: HIT_LOCATION.LC, fielding: true},
	...
	1: {
		...
		7: {
			...
			5: {position: BASE[3], fielding: true},
			6: {position: BASE[2]},
			7: {fielding: true},
			8: {position: {left: 750, top: 170}},
			9: {position: {left: 300, top: 170}}
	...
	12: {
		...
		7: {
			...
			advance: [1, 2],
			1: {},
			2: {position: BASE.H, fielding: true},
			3: {position: BASE[1]},
